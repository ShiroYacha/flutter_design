// Impl. copy and modified from Dart SDK 2.15.1
//
...
///
/// Remark: adjusted to ignore annotations
class ToSourceIgnoringDesignAnnotationsVisitor implements AstVisitor<void> {
  ...
  ToSourceIgnoringDesignAnnotationsVisitor(this.sink);
  ...
  void visitAnnotation(Annotation node) {
    if (!_annotationsToIgnore.contains(node.name.name)) {
      sink.write('@');
