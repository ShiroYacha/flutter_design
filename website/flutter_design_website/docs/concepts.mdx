...
app to totally separate your production code & designer code. The downside is the cost to maintain such code and structure (especially in case of interface change).
:::
...
:::note
For more information about how to use the code generator, please check [codegen](/docs/codegen/annotation).
:::
