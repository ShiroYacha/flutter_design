...
:::note
For more inforamtion on how to build different pages, see [Pages](/docs/designer/pages).
:::
...
- **Page**: contains many different sections such as widget designer, text paragraphs, custom widgets, etc.
